...
<div class="kt-subheader  kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">CMS Page List</h3>
        </div>
        <div class="kt-subheader__toolbar">
            <a href="{{route('admin.cmspages.create')}}" class="btn btn-primary btn-bold"><i class="fa fa-plus"></i> Add New</a>
        </div>
    </div>
</div>
<!-- end:: Content Head -->
...
<script>
    $(function () {
        var table = $('.data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                'url': "{{ route('admin.cmspages.getall') }}",
                'type': 'POST',
                headers: {
