            ...
            <div class="kt-widget kt-widget--user-profile-1">
                <div class="kt-widget__head">
                    <div class="kt-widget__media">
                        <img src="{{url('/assets/media/users/300_25.jpg')}}" alt="image">
                    </div>
                ...
                <div class="kt-widget__body">
                    <div class="kt-widget__content">
                        <div class="kt-widget__info">
                            ...
                            <a href="javascript:" class="kt-widget__data">{{isset(Auth::user()->email) ? Auth::user()->email : '-'}}</a>
                        </div>
                        <!--                        <div class="kt-widget__info">
                                                    <span class="kt-widget__label">Phone:</span>
                                                    <a href="javascript:" class="kt-widget__data">{{isset(Auth::user()->phone_number) ? Auth::user()->phone_number : '-'}}</a>
                                                </div>
                                                <div class="kt-widget__info">
                                                    <span class="kt-widget__label">Location:</span>
                                                    <span class="kt-widget__data">{{isset(Auth::user()->address) ? Auth::user()->address : '-'}}</span>
                                                </div>-->
                    </div>
