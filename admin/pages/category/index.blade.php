...
@section('title', 'Industry Category List')
@section('content')
...
<div class="kt-subheader  kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Industry Category List</h3>
        </div>
            ...
            <form id="myForm">
                <div class="row">
                    <div class="col-md-6 form-group">
                        <input type="text" name="name" class="form-control" placeholder="Enter category name"@if(isset($edit)) value="{{ $edit->name }}" @endif>
                    </div>
                    <div class="col-md-6 form-group">
                        @if(isset($edit)) 
