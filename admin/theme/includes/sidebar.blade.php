    ...
    <div class="kt-aside__brand kt-grid__item" id="kt_aside_brand">
        <div class="kt-aside__brand-logo">
            <a href="{{route('admin.home')}}">
                <img style="width: 80px;" alt="Logo" src="{{ asset('sitebucket/other/logo-1.png') }}" />
            </a>
        </div>
    ...
    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
            <ul class="kt-menu__nav ">
                ...
                <li class="kt-menu__item " aria-haspopup="true">
                    <a href="{{route('admin.cmspages.index')}}" class="kt-menu__link ">
                ...
                <li class="kt-menu__item " aria-haspopup="true">
                    <a href="{{route('admin.category.index')}}" class="kt-menu__link ">
                        <span class="kt-menu__link-icon"><i class="fa fa-align-justify"></i></span>
                        <span class="kt-menu__link-text">Industry Category</span>
                    </a>
                </li>
                <li class="kt-menu__item " aria-haspopup="true">
                    <a href="{{route('admin.subcategory.index')}}" class="kt-menu__link ">
                        <span class="kt-menu__link-icon"><i class="fa fa-list"></i></span>
                        <span class="kt-menu__link-text">Industry Sub Category</span>
                    </a>
                </li>
            </ul>
        </div>
