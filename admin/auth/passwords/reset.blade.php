            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                <div class="kt-login__container">
                    <div class="kt-login__logo">
                        <a href="javascript:">
                            <img style="width: 150px;" src="{{ asset('sitebucket/other/logo-1.png') }}">
                        </a>
                    </div>
                    <div class="kt-login__forgot" style="display: block;">
                        ...
                        <form class="kt-form" method="POST" action="{{ route('admin.password.update') }}">
                            @csrf
                            <input type="hidden" name="token" value="{{ $token }}">
                            <div class="input-group">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ Request::input('email') ?? old('email') }}" required autocomplete="email" autofocus>
                                @error('email')
