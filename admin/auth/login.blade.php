                    ...
                    <div class="kt-login__signin">
                        ...
                        <form class="kt-form" method="POST" action="{{ route('admin.login') }}">
                            ...
                            <div class="input-group">
                                <input class="form-control" type="text" placeholder="Email" name="email" value="{{ old('email') }}" autofocus="" autocomplete="off">
                                @if ($errors->has('email'))
                            ...
                            <div class="row kt-login__extra">
                                ...
                                <div class="col kt-align-right">
                                    <a href="{{ route('admin.password.request') }}" id="kt_login_forgot" class="kt-link kt-login__link">Forget Password ?</a>
                                </div>
                            </div>
